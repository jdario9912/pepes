...
const LomaComp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const ubicacionArchivo = document.querySelector(
      ...
      >
        ...
        <div className="nueva-orden--container-1">
          <div className="nueva-orden--container-2">
            ...
            <InputRadio
              texto="Troquelado"
              accion={setTroquelado}
              opciones={opcionesTroquelado}
              name="troquelado"
            />
            <InputRadio
              texto="Portabaner"
              accion={setPortabaner}
              opciones={opcionesPortabaner}
              name="portabaner"
            />
            <InputRadio
              texto="Corte"
