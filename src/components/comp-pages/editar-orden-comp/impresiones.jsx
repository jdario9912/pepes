        ...
        >
          ...
          <table className="editar-orden--table">
            ...
            <tr>
              <td>Faz</td>
              <td>
                <InputSelect valor={dataS.faz} data="faz" opciones={faz} />
              </td>
            </tr>
            <tr>
              <td>Tipo</td>
              <td>
                <InputText valor={dataS.tipo_papel} data="tipo-papel" />
              </td>
            </tr>
            <tr>
              <td>Tamaño</td>
              <td>
                <InputSelect
                  valor={dataS.tamano_papel}
                  data="tamano-papel"
                  opciones={tamano_papel}
                />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Corte</td>
              <td>
                <InputSelect valor={dataS.corte} data="corte" opciones={siNo} />
              </td>
            </tr>
          </table>
