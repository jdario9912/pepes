...
Sistema para registrar clientes y ordenes de trabajo.

Cuenta con un sistema de login, permisos de usuario y administrador.

Tecnologías utilizadas: ReactJs, CSS, NodeJs y MySQL.
